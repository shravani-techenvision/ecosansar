        ...
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    ...
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$recyclablepost}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Recyclable Post</b></p>
                </div>
                <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last week-->
                <!--</p>-->
            </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    <h3><i class="fas fa-file-alt"></i></h3>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$reusablepost}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Reusable post</b></p>
                </div>
                <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last week-->
                <!--</p>-->
            </div>

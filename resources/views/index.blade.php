...
@slot('pagetitle') Ecosansar @endslot
@slot('title') Dashboard @endslot
@endcomponent

<style>
    div#total-revenue-chart {
    display: none;
}
...
<div class="row">
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    <h3><i class="fas fa-users"></i></h3>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$Corporateusers}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Corporate users</b></p>
                </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    <h3><i class="fas fa-users"></i></h3>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$Contributorusers}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Contributor users</b></p>
                </div>
                <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last week-->
                <!--</p>-->
            </div>
        ...
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    ...
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$totalpostCount}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Post</b></p>
                </div>
                <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last week-->
                <!--</p>-->
            </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    <h3><i class="fas fa-file-alt"></i></h3>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$Corporatepost}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Corporate post</b></p>
                </div>
                <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last week-->
                <!--</p>-->
            </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    <h3><i class="fas fa-file-alt"></i></h3>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$Contributorpost}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Contributor post</b></p>
                </div>
                <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last week-->
                <!--</p>-->
            </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card">
            <div class="card-body new">
                ...
                <div>
                    <h3><i class="fas fa-file-alt"></i></h3>
                    <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{$Resourcepost}}</span></h4>
                    <p class="text-muted mb-0"><b>Total Resource post</b></p>
                </div>
                <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last week-->
                <!--</p>-->
            </div>
    ...
    <!--            </div>-->
    <!--            <div>-->
    <!--                <h4 class="mb-1 mt-1"><span data-plugin="counterup">tt</span></h4>-->
    <!--                <p class="text-muted mb-0">Sabusers</p>-->
    <!--            </div>-->

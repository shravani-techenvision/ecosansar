                ...
                <div class="image">
                    <div class="  bg-transfer">
                        @php
                            ...
                            $imagePath = !empty($businposts->resource_img) ? 'Businessposts/' . $businposts->resource_img : null;
...
<script>
        function initMap() {
            ...
            const latitude = {{ $businessposts->latitude }};
            const longitude = {{ $businessposts->longitude }};

...
@endif
    ...
    <div class="row">
         ...
         <a href="{{route('con_all_posts')}}" class="btn btn-primary btn-small btn-rounded icon shadow add-listing">Browse all Buyers</a> 
          @else
        <a href="{{ route('consumer_login') }}" class="btn btn-primary btn-small btn-rounded icon shadow add-listing">Browse all Buyers</a>
    @endif
    </div>
@endif
    <!--end row-->
...
@endif
        ...
        <span>Connect</span>
                   ...
                   <div class="row">
    @if (session()->has('user_id'))
        <a href="{{ route('sab_all_buy_posts') }}" class="btn btn-primary btn-small btn-rounded icon shadow add-listing">Browse all Buyers</a>
    @else
        <a href="{{ route('consumer_login') }}" class="btn btn-primary btn-small btn-rounded icon shadow add-listing">Browse all Buyers</a>
    @endif
</div>
...
@endif
        ...
        <span>Connect</span>
                    ...
                    <div class="row">
                         @if (session()->has('user_id'))
         <a href="{{route('bus_all_buy_posts')}}" class="btn btn-primary btn-small btn-rounded icon shadow add-listing">Browse all Buyers</a> 
         @else
        <a href="{{ route('consumer_login') }}" class="btn btn-primary btn-small btn-rounded icon shadow add-listing">Browse all Buyers</a>
    @endif
    </div>

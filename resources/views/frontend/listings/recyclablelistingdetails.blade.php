		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-12">
					<h2 class="breadcrumb-title mb-2">Recyclable Listing Details</h2>
                            ...
                            <div class="service-wrap mb-4">
                                <div class="service-img text-center">
                                     @php
                                        ...
                                        $imagePath = !empty($posts->resource_img) ? 'Recyclableposts/' . $posts->resource_img : null;
											...
											<div class="accordion-body border-0 p-0 pt-3">
												...
												<div class="bg-light-200 p-3 offer-wrap">
													...
													<div class="offer-item d-md-flex align-items-center justify-content-between bg-white mb-2">
														...
														<div class="pb-3">
															<h6 class="fs-16 fw-medium text-primary mb-0">{{ $posts->resource->resource_name }}</h6>
													...
													<div class="offer-item d-md-flex align-items-center justify-content-between bg-white mb-2">
														<div class="d-sm-flex align-items-center mb-2">
															...
															<div class="mb-2">
																<h6 class="fs-16 fw-medium">Pincode</h6>
															 
															</div>
														</div>
														<div class="pb-3">
															<h6 class="fs-16 fw-medium text-primary mb-0">{{$posts->pincode}}</h6>
					...
					<div class="col-xl-4 theiaStickySidebar">
						<div class="card border-0">
							<div class="card-body">
								...
								<a href="#" data-id="{{ $posts->id }}" data-bs-toggle="modal" data-bs-target="#add-contact" class="btn btn-lg btn-linear-primary w-50 d-flex align-items-center justify-content-center mb-3 consumer-connect-listing"><i class="ti ti-user me-2"></i>Connect</a>
        ...
        {{ $reviewsCount == 1 ? 'review' : 'reviews' }})</p>
									...
									<div class="d-flex align-items-center">
										<div class="social-icon">
										  @if (session()->has('user_id'))
											<a href="https://wa.me/?text={{ urlencode('This post from The ZeroWaste Community Tool might interest you, check it out : ' . url('recyclable_listing_details/'.$posts->id)) }}" target="_blank" class="me-2"><img src="{{asset('frontend/assets/img/icons/whatsapp.svg') }}" class="img" alt="icon"></a>
										 @else
										    	<a href="{{ route('consumer_login', ['redirect_wp' => url('recyclable_listing_details/' . $posts->id)]) }}" target="_blank"></a>
										  @endif 	
										</div>
									</div>
								</div>
								<div class="row border-top pt-3 g-2">
									...
									<div class="col-sm-6">
									 @if (!$hideAddReviewButton)
										    <a href="{{ url('recyclablepostprofile'). "/".$u_id }}"    class="btn btn-lg btn-linear-primary w-100  "><i class="fa-regular fa-comment-dots me-2"></i></i>Add Review</a> 
									    @endif
									</div>
				...
				<div class="row mt-5 d-flex justify-content-center">
                                                                    <div class="col-md-3 mb-2">
                                                                        <a href="{{route('listings')}}" class="btn btn-linear-primary btn-lg w-100">  Go back to Listings Page</a>
                                                                    </div>
			...
			<div class="modal-content">
				...
				<form action="{{ route('recyclable_enquiry_save') }}" method="POST">
					...
					<div class="modal-footer d-flex align-items-center justify-content-center">
						...
						<button type="submit" class="btn btn-linear-primary btn-lg w-md-50">Submit</button>
					</div>
				</form>				
			</div>
		</div>

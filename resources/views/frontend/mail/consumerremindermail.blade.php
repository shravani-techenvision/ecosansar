...
<section style="background-color:#edf2f7; padding: 81px 0px;">
    ...
    <p>This is a reminder that your listing uploded on {{$date}} resource type : {{$resource_type}} ({{$weight})  will be deactivated in 2 days. We hope you have
        made a connection for this listing!
        </p>

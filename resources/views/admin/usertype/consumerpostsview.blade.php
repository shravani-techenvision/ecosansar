        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4"> 
                        <p class="mb-0"><strong>Price:</strong><br>
                        <p>@isset($users->resource_price){{ $users->resource_price }}@endisset</p>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-4">
                        ...
                        <p>@isset($users->resource_des){{ $users->resource_des }}@endisset</p>
                    </div>
                    <div class="col-4">
                    ...
                    <p class="mb-0"><strong>Post Image:</strong><br>
                        ...
                        <p class="mb-0"><strong></strong>
                         <img src="{{ Storage::disk('s3')->url('Consumerposts/' . $users->resource_img) }}" alt="Post Image" class="mb-2" style="max-width: 200px;">

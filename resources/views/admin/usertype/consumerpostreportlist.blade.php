...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <!-- Date Filter Form -->
            <form method="POST" action="{{ route('user.shortconsumerReportList') }}">
                @csrf
                <div class="form-row">
                    <div class="row">
                    <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col">
                        ...
                        <a href="{{route('user.consumerpostreportlist')}}" class="btn btn-primary">Cancel</a>
                    </div>

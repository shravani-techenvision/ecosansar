...
@section('title')
    Reusable Resource Post Add
@endsection

@section('content')
@component('common-components.breadcrumb')
@slot('pagetitle')   Add @endslot
@slot('title') Resource Post @endslot
@endcomponent
<head>
...
<div class="row justify-content-center align-items-center" style="margin-left: 200px;margin-top: 50px;">
    <div class="col-lg-10">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="col-lg-12">
                        <div class="mt-4">
                            <form id="locationForm" action="{{ route('reusable_resource_post.save') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                                        ...
                                                        <div id="accordion-collapseOne"
                                                            ...
                                                            <!--</div></div></div>-->
                                                                  <div class="row mt-2 g-4">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" onclick="geocodeAddress()" >Show on Map</button><br><br>
                                                             </div> </div>
                                                             <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row   d-flex justify-content-center text-center">
                                                                    ...
                                                                    <div class="col-md-3 mb-2">
                                                                        <button type="submit"
                                                                            class="btn btn-primary btn-lg w-100">Post</button>
                                                                    </div>

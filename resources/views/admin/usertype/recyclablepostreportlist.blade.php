...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <!-- Date Filter Form -->
            <form method="POST" action="{{route('user.shortrecyclableReportList')}}">
                @csrf
                <div class="form-row">
                    <div class="row">
                    <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="col">
                        ...
                        <a href="{{route('user.recyclablepostreportlist')}}" class="btn btn-primary">Cancel</a>
                    </div>
                    ...
                    <!--    style="border-collapse: collapse; border-spacing: 0; width: 100%;">-->
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td>{{ $res->resource_names }}</td>
                                        <td>{{ $res->pincode }}</td>
                                        <td>{{ $res->sale_giveaway }}</td>
                                        <td>{{ \Carbon\Carbon::parse($res->post_date)->format('F j, Y \a\t g:i A') }}</td>

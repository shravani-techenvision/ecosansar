...
<script>
 ...
 <script>
   document.addEventListener('DOMContentLoaded', function () {
    ...
    const userTypeInput = document.getElementById('user_type'); // Reference to user_type field
    ...
    assignPlanModal.addEventListener('show.bs.modal', function (event) {
        ...
        const userType = button.getAttribute('data-user-type'); // Extract user type

        const userIdInput = assignPlanModal.querySelector('#user_id');
        userIdInput.value = userId || ''; // Set user ID or clear it

        userTypeInput.value = userType || ''; // Set user type or clear it
    });
    ...
    planSelect.addEventListener('change', function () {
        ...
        planValidityInput.value = planValidity || ''; // Set or clear plan validity
    });
});

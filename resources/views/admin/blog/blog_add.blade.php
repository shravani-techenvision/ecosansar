                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="editor" name="content"  >@if(isset($blog->content)){{$blog->content}}@else{{old('content')}}@endif</textarea>
...
<script>
    ...
    ClassicEditor
      .create(document.querySelector('#editor'), {
        ckfinder: {
          uploadUrl: "{{ url('/upload-image') }}", // Ensure URL is correct
        }
      })
      .then(editor => {
      ...
      upload() {
        return this.loader.file.then(file => {
          return new Promise((resolve, reject) => {
            ...
            formData.append('upload', file); // Make sure to use 'upload' as the key

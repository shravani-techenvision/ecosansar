        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div >
                        <a href="{{ route('blog.blog_add') }}" class="btn btn-primary waves-effect waves-light" >Add</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                           ...
                                           <td>{{ $res->category_name }}</td>
                                            <td>
                                                ...
                                                <a title="Edit" href="{{ route('blog.blog_edit', $res->id) }}" class="btn btn-outline-success btn-sm edit"><i class="fas fa-pencil-alt"></i></a>
                                                <a title="Delete" href="{{ route('blog.blog_delete', $res->id) }}" onclick="return confirm('Are you sure you want to delete this blog?');" class="btn btn-outline-danger btn-sm deleteAttr"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                            <td>

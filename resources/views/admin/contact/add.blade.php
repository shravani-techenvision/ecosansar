                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input   type="text" class="form-control" value="@if (isset($contact->facebook)) {{ $contact->facebook }} @endif" name="facebook" id="facebook" value="">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input   type="text" class="form-control" value="@if (isset($contact->insta)) {{ $contact->insta }} @endif" name="insta" id="insta" placeholder="Enter Your Instagram Page Url">
                                           <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input   type="text" class="form-control" value="@if (isset($contact->twitter)) {{ $contact->twitter }} @endif" name="twitter" id="twitter" placeholder="Enter Your Twitter Page Url">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input   type="text" class="form-control" value="@if (isset($contact->linkedin)) {{ $contact->linkedin }} @endif" name="linkedin" id="linkedin" placeholder="Enter Your LinkedIn page Url">
                                           <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input   type="text" class="form-control" value="@if (isset($contact->utube)) {{ $contact->utube }} @endif" name="utube" id="utube" placeholder="Enter Your Youtube page Url">
                                           <div class="invalid-feedback">
